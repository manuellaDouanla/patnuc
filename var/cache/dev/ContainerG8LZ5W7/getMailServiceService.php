...
class getMailServiceService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Services/MailService.php';
        ...
        return $container->privates['App\\Service\\MailService'] = new \App\Service\MailService($a, ($container->privates['parameter_bag'] ??= new \Symfony\Component\DependencyInjection\ParameterBag\ContainerBag($container)));
    }
}
