...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Api\\Access\\CreateAccessController' => 'getCreateAccessControllerService',
            'App\\Controller\\Api\\Access\\DeleteAccessController' => 'getDeleteAccessControllerService',
            'App\\Controller\\Api\\Access\\GetAccessController' => 'getGetAccessControllerService',
            'App\\Controller\\Api\\Access\\UpdateAccessController' => 'getUpdateAccessControllerService',
            'App\\Controller\\Api\\Logs\\LogsController' => 'getLogsControllerService',
            'App\\Controller\\Api\\Roles\\CreateRolesController' => 'getCreateRolesControllerService',
            'App\\Controller\\Api\\Roles\\DeleteRolesController' => 'getDeleteRolesControllerService',
            'App\\Controller\\Api\\Roles\\GetRolesController' => 'getGetRolesControllerService',
            'App\\Controller\\Api\\Roles\\UpdateRolesController' => 'getUpdateRolesControllerService',
            'App\\Controller\\Api\\Taches\\CreateTachesController' => 'getCreateTachesControllerService',
            'App\\Controller\\Api\\Taches\\DeleteTachesController' => 'getDeleteTachesControllerService',
            'App\\Controller\\Api\\Taches\\GetTachesController' => 'getGetTachesControllerService',
            'App\\Controller\\Api\\Taches\\UpdateTachesController' => 'getUpdateTachesControllerService',
            'App\\Controller\\Api\\Users\\BulkMailController' => 'getBulkMailControllerService',
            'App\\Controller\\Api\\Users\\CreateUsers\\CreateUsersController' => 'getCreateUsersControllerService',
            'App\\Controller\\Api\\Users\\DeleteUsers\\DeleteUsersController' => 'getDeleteUsersControllerService',
            'App\\Controller\\Api\\Users\\InfoUsers\\InfoUsersController' => 'getInfoUsersControllerService',
            'App\\Controller\\Api\\Users\\ListUsers\\ListUsersController' => 'getListUsersControllerService',
            'App\\Controller\\Api\\Users\\Login\\LoginController' => 'getLoginControllerService',
            'App\\Controller\\Api\\Users\\PasswordReset\\PasswordResetController' => 'getPasswordResetControllerService',
            'App\\Controller\\Api\\Users\\UpdateUsers\\UpdateUsersController' => 'getUpdateUsersControllerService',
            'App\\Controller\\Modules\\CreateModuleController' => 'getCreateModuleControllerService',
            'App\\Controller\\Modules\\DeleteModuleController' => 'getDeleteModuleControllerService',
            'App\\Controller\\Modules\\ListModuleController' => 'getListModuleControllerService',
            'App\\Controller\\Modules\\UpdateModuleController' => 'getUpdateModuleControllerService',
            'App\\Controller\\Projets\\CreateProjetsController' => 'getCreateProjetsControllerService',
            'App\\Controller\\Projets\\DeleteProjetsController' => 'getDeleteProjetsControllerService',
            'App\\Controller\\Projets\\GetProjetsController' => 'getGetProjetsControllerService',
            'App\\Controller\\Projets\\UpdateProjetsController' => 'getUpdateProjetsControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('wQDkf7zV7Z', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FYjn-l1o0U', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zDUHB0qwdv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('A0vKl63KAQ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\Access\\AccessRepository' => ['privates', 'App\\Repository\\Access\\AccessRepository', 'getAccessRepositoryService', true],
            'App\\Repository\\Logs\\LogsRepository' => ['privates', 'App\\Repository\\Logs\\LogsRepository', 'getLogsRepositoryService', true],
            'App\\Repository\\Modules\\ModulesRepository' => ['privates', 'App\\Repository\\Modules\\ModulesRepository', 'getModulesRepositoryService', true],
            'App\\Repository\\Projets\\ProjetsRepository' => ['privates', 'App\\Repository\\Projets\\ProjetsRepository', 'getProjetsRepositoryService', true],
            'App\\Repository\\Roles\\RolesRepository' => ['privates', 'App\\Repository\\Roles\\RolesRepository', 'getRolesRepositoryService', true],
            'App\\Repository\\Taches\\TachesRepository' => ['privates', 'App\\Repository\\Taches\\TachesRepository', 'getTachesRepositoryService', true],
            'App\\Repository\\Token\\TokenRepository' => ['privates', 'App\\Repository\\Token\\TokenRepository', 'getTokenRepositoryService', true],
            'App\\Repository\\Users\\UsersRepository' => ['privates', 'App\\Repository\\Users\\UsersRepository', 'getUsersRepositoryService', true],
        ], [
            'App\\Repository\\Access\\AccessRepository' => '?',
            'App\\Repository\\Logs\\LogsRepository' => '?',
            'App\\Repository\\Modules\\ModulesRepository' => '?',
            'App\\Repository\\Projets\\ProjetsRepository' => '?',
            'App\\Repository\\Roles\\RolesRepository' => '?',
            'App\\Repository\\Taches\\TachesRepository' => '?',
            'App\\Repository\\Token\\TokenRepository' => '?',
            'App\\Repository\\Users\\UsersRepository' => '?',
        ])));
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Api\\Access\\CreateAccessController', 'App\\Controller\\Api\\Access\\DeleteAccessController', 'App\\Controller\\Api\\Access\\GetAccessController', 'App\\Controller\\Api\\Access\\UpdateAccessController', 'App\\Controller\\Api\\Logs\\LogsController', 'App\\Controller\\Api\\Roles\\CreateRolesController', 'App\\Controller\\Api\\Roles\\DeleteRolesController', 'App\\Controller\\Api\\Roles\\GetRolesController', 'App\\Controller\\Api\\Roles\\UpdateRolesController', 'App\\Controller\\Api\\Taches\\CreateTachesController', 'App\\Controller\\Api\\Taches\\DeleteTachesController', 'App\\Controller\\Api\\Taches\\GetTachesController', 'App\\Controller\\Api\\Taches\\UpdateTachesController', 'App\\Controller\\Api\\Users\\BulkMailController', 'App\\Controller\\Api\\Users\\CreateUsers\\CreateUsersController', 'App\\Controller\\Api\\Users\\DeleteUsers\\DeleteUsersController', 'App\\Controller\\Api\\Users\\InfoUsers\\InfoUsersController', 'App\\Controller\\Api\\Users\\ListUsers\\ListUsersController', 'App\\Controller\\Api\\Users\\Login\\LoginController', 'App\\Controller\\Api\\Users\\PasswordReset\\PasswordResetController', 'App\\Controller\\Api\\Users\\UpdateUsers\\UpdateUsersController', 'App\\Controller\\Modules\\CreateModuleController', 'App\\Controller\\Modules\\DeleteModuleController', 'App\\Controller\\Modules\\ListModuleController', 'App\\Controller\\Modules\\UpdateModuleController', 'App\\Controller\\Projets\\CreateProjetsController', 'App\\Controller\\Projets\\DeleteProjetsController', 'App\\Controller\\Projets\\GetProjetsController', 'App\\Controller\\Projets\\UpdateProjetsController', 'App\\Controller\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('99ikrCnpku', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dNwJOp1rRm', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NRnfg5MVA0', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('t66E1jADVS', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qUuFuhzDBG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-HawBoCh9N', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getSecurity_ContextListener_0Service($container)
    {
        return $container->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['security.user.provider.concrete.users_in_database'] ?? $container->load('getSecurity_User_Provider_Concrete_UsersInDatabaseService'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'app.mailer_sender' => 'ppatnuc@gmail.com',
